...
export const corehrV2ApprovalGroupsOpenQueryDepartmentChangeListByIds = {
  ...
  httpMethod: 'POST',
  description:
    '[Feishu/Lark]-飞书人事（企业版）-组织架构调整-批量查询部门调整内容-根据部门调整记录 ID 批量查询部门调整内容，如：部门调整类型、部门调整前后名称、部门调整前后角色信息 等',
  accessTokens: ['tenant'],
  schema: {
    data: z
      .object({
        department_change_ids: z
          .array(z.string())
          .describe(
            '部门调整记录 ID 列表。调整记录详情可通过[【根据流程 ID 查询组织架构调整记录】] 获取。 - 必须是查询参数process_id对应的流程下的部门调整记录ID。- 未设置时查询到的部门调整记录为空。- 返回的变更 ID 类型与 查询参数中的```department_id_type``` 一致。',
          )
          .optional(),
    ...
    data: z
      .object({
        job_change_ids: z
          .array(z.string())
          .describe(
            '人员异动记录 ID List, 在组织架构调整发起后，会为调整涉及的员工生成一个 员工异动记录， 对应的记录 ID 即为 job_change_id。 调整记录可通过[【根据流程 ID 查询组织架构调整记录】] 获取。',
          )
          .optional(),
...
export const corehrV2ApproverList = {
  ...
  httpMethod: 'GET',
  description:
    '[Feishu/Lark]-飞书人事（企业版）-流程-审批任务-获取指定人员审批任务列表-审批任务依赖于流程节点实例存在，每一个流程节点实例可能包含有一或多个审批任务，每一个任务表明当前节点的审批人是谁，该接口可获取指定人员的审批任务列表（此功能不受数据权限范围控制）',
  accessTokens: ['tenant'],
  schema: {
    params: z.object({
...
export const corehrV2CompanyActive = {
  ...
  schema: {
    data: z.object({
      company_id: z.string().describe('公司 ID- 可从 [批量查询公司]的 id 字段中获取'),
      effective_time: z
        .string()
        .describe(
...
export const corehrV2CostAllocationCreateVersion = {
  ...
  schema: {
    data: z.object({
      employment_id: z.string().describe('员工雇佣 ID-可以调用[【搜索员工信息】]接口，获取指定员工的 employment_id'),
      cost_allocation: z
        .object({
...
export const corehrV2CostAllocationUpdateVersion = {
  ...
  schema: {
    data: z.object({
      ...
      cost_allocation: z
        .object({
          wk_id: z.string().describe('wk_id-可以调用[【查询成本分摊】]接口，获取对应成本分摊信息的成本分摊ID'),
...
export const corehrV2CostCenterPatch = {
  ...
  schema: {
    ...
    path: z
      .object({
        cost_center_id: z.string().describe('成本中心ID，可通过[【搜索成本中心信息】]接口查询获得').optional(),
      })
      .optional(),
  },
};
...
export const corehrV2CostCenterVersionCreate = {
  ...
  httpMethod: 'POST',
  description:
    '[Feishu/Lark]-飞书人事（企业版）-组织管理-成本中心-成本中心版本-创建成本中心版本-创建成本中心版本；每次调用可创建一个成本中心版本，可定义成本中心的名称，描述，上级成本，成本中心负责人，版本生效时间等信息，接口内会做相关规则的校验',
  accessTokens: ['tenant'],
  schema: {
    data: z.object({
      name: z
        ...
        .describe('成本中心名称'),
      parent_cost_center_id: z.string().describe('上级成本中心ID，可通过[【搜索成本中心信息】]接口查询获得').optional(),
      managers: z.array(z.string()).describe('成本中心负责人ID 列表，可通过[【搜索员工信息】]接口获取').optional(),
      description: z
        .array(
          z.object({
            lang: z.string().describe('信息的语言，支持中文和英文。中文用zh-CN；英文用en-US'),
...
export const corehrV2CostCenterVersionDelete = {
  ...
  httpMethod: 'DELETE',
  description:
    '[Feishu/Lark]-飞书人事（企业版）-组织管理-成本中心-成本中心版本-撤销成本中心版本-该接口支持通过成本中心的版本ID撤销成本中心版本信息',
  accessTokens: ['tenant'],
  schema: {
    data: z.object({ operation_reason: z.string().describe('操作原因') }),
    path: z
      .object({
        cost_center_id: z.string().describe('成本中心ID，可通过[【搜索成本中心信息】]接口查询获得').optional(),
        version_id: z.string().describe('版本ID，可通过[【搜索成本中心信息】]接口查询获得').optional(),
      })
      .optional(),
  },
};
export const corehrV2CostCenterVersionPatch = {
  ...
  httpMethod: 'PATCH',
  description:
    '[Feishu/Lark]-飞书人事（企业版）-组织管理-成本中心-成本中心版本-更正成本中心版本-对成本中心的版本记录进行更正，可更正的字段包括：名称，上级成本中心，成本中心负责人列表，成本中心的描述，生效时间',
  accessTokens: ['tenant'],
  schema: {
    data: z.object({
      name: z
...
export const corehrV2CustomOrgActive = {
  ...
  schema: {
    data: z.object({
      org_id: z.string().describe('自定义组织 ID- 可从 [批量查询自定义组织]的 org_id 字段中获取'),
  ...
  schema: {
    data: z.object({
      ...
      code: z
        ...
        .optional(),
      parent_id: z.string().describe('上级组织 ID- 可从 [批量查询自定义组织]的 org_id 字段中获取').optional(),
      manager_ids: z
        .array(z.string())
        .describe(
          '负责人 ID 列表。- 详细信息可通过[【搜索员工信息】] 或 [【批量查询员工】] 接口获取，ID 为返回值中的 ==employment_id==',
    ...
    params: z
      ...
      .optional(),
    path: z.object({ org_id: z.string().describe('自定义组织 ID- 可从 [批量查询自定义组织]的 org_id 字段中获取') }),
  },
};
...
export const corehrV2DepartmentDelete = {
  ...
  schema: {
    params: z
      ...
      .optional(),
    path: z.object({ department_id: z.string().describe('需要删除的部门 ID，可通过[【搜索部门信息】]接口查询获得') }),
  },
};
...
export const corehrV2DepartmentQueryMultiTimeline = {
  ...
  schema: {
    data: z.object({
      department_ids: z.array(z.string()).describe('部门 ID 列表，可请求[搜索部门信息]获取'),
...
export const corehrV2DepartmentQueryTimeline = {
  ...
  schema: {
    data: z.object({
      department_ids: z.array(z.string()).describe('部门 ID 列表- 可通过[批量查询部门V2] 或者[搜索部门信息] 获取详情'),
      effective_date: z
        .string()
        .describe(
      ...
      .object({
        personal_info: z
          .object({
            personal_basic_info: z
              .object({
                ...
                gender: z
                  ...
                  .optional(),
                nationality_v2: z.string().describe('国籍 ID可通过[【查询国籍信息】]接口获取').optional(),
                ethnicity_race: z
                  .string()
                  .describe(
                  ...
                  address: z
                    .object({
                      ...
                      country_region: z
                        ...
                        .optional(),
                      region: z.string().describe('主要行政区 ID可通过[【查询省份/行政区信息】]接口获取').optional(),
                      ...
                      city_v2: z.string().describe('城市V2 ID可通过[【查询城市信息】]接口获取').optional(),
                      ...
                      district_v2: z.string().describe('区/县 V2 ID可通过[【查询区/县信息】]接口获取').optional(),
            ...
            bank_accounts: z
              .array(
                z.object({
                  country_region: z.string().describe('国家 / 地区 ID可通过[【查询国家/地区信息】]接口获取').optional(),
                  ...
                  bank_account_type: z
                    ...
                    .optional(),
                  bank_id: z.string().describe('银行 ID可通过[【查询银行信息】]接口获取').optional(),
                  branch_id: z.string().describe('银行支行 ID可通过[【查询支行信息】]接口获取').optional(),
                  payment_type: z
                ...
                z.object({
                  ...
                  address: z
                    .object({
                      ...
                      region_subdivision_1: z.string().describe('主要行政区往下细分 1 层的行政区').optional(),
                      region_subdivision_2: z.string().describe('主要行政区往下细分 2 层的行政区').optional(),
                      city_v2: z.string().describe('城市 V2 ID可通过[【查询城市信息】]接口获取').optional(),
                      city_text: z.string().describe('城市（文本）').optional(),
                      local_city_text: z.string().describe('城市（仅文本，非拉丁语系的本地文字）').optional(),
                      city_subdivision_1: z.string().describe('城市往下细分 1 层的行政区').optional(),
                      city_subdivision_2: z.string().describe('城市往下细分 2 层的行政区').optional(),
        ...
        employment_info: z
          .object({
            ...
            employment_record: z
              .object({
                employee_type: z.string().describe('人员类型 ID可通过[【批量查询人员类型】]接口获取').optional(),
                department: z.string().describe('部门 ID可通过[【批量查询部门】]接口获取').optional(),
                direct_manager: z.string().describe('直属上级雇佣 ID可通过[【搜索员工信息】]接口获取').optional(),
                working_hours_type: z.string().describe('工时制度 ID可通过[【批量查询工时制度】]接口获取').optional(),
                cost_centers: z
                  .array(
                    z.object({
                      id: z
                ...
                dotted_line_manager: z.string().describe('虚线上级雇佣 ID可通过[【搜索员工信息】]接口获取').optional(),
                dotted_line_manager_effective_time: z.string().describe('虚线上级入职日期').optional(),
                job: z.string().describe('职务 ID可通过[【批量查询职务】]接口获取').optional(),
                job_family: z.string().describe('序列 ID可通过[【批量查询序列】]接口获取').optional(),
                job_level: z.string().describe('职级 ID可通过[【批量查询职级】]接口获取').optional(),
                job_grade: z.string().describe('职等 ID可通过[【查询职等】]接口获取').optional(),
                work_location: z.string().describe('工作地点 ID可通过[【批量查询地点】]接口获取').optional(),
    ...
    params: z
      .object({
        ...
        rehire: z
          ...
          .optional(),
        rehire_employment_id: z.string().describe('离职重聘员工雇佣 ID可通过[【搜索员工信息】]接口获取').optional(),
    ...
    data: z
      .object({
        ...
        employment_status: z
          ...
          .optional(),
        employee_type_id: z.string().describe('人员类型 ID，可通过[【批量查询人员类型】]接口获取').optional(),
        department_id_list: z
          .array(z.string())
          .describe(
        ...
        service_company_list_include_sub: z
          ...
          .optional(),
        job_family_id_list: z.array(z.string()).describe('序列 ID 列表 - [【批量查询序列】]获取').optional(),
...
export const corehrV2EmployeesAdditionalJobBatch = {
  ...
  httpMethod: 'POST',
  description:
    '[Feishu/Lark]-飞书人事（企业版）-员工信息-任职信息-兼职信息-批量查询兼职信息-批量查询兼职信息，包括开始日期、职务、序列、上级、薪资类型等信息。支持全量遍历和筛选查询',
  accessTokens: ['tenant'],
  schema: {
    data: z
      .object({
...
export const corehrV2EmployeesAdditionalJobCreate = {
  ...
  schema: {
    data: z.object({
      employee_type_id: z.string().describe('人员类型 ID，可通过[【批量查询人员类型】]获取'),
      working_hours_type_id: z.string().describe('工时制度 ID，可通过[【批量查询工时制度】]获取详细信息').optional(),
      work_location_id: z
        .string()
        .describe(
        ...
        .optional(),
      department_id: z.string().describe('部门 ID，可通过[【批量查询部门】]获取详细信息类型与 department_id_type 一致'),
      job_id: z.string().describe('职务 ID，可通过[【批量查询职务】]获取详细信息').optional(),
      job_level_id: z.string().describe('职级 ID，可通过[【批量查询职级】]获取详细信息').optional(),
      job_family_id: z.string().describe('序列 ID，可通过[【批量查询序列】]获取详细信息').optional(),
      employment_id: z.string().describe('雇佣 ID，可通过[【批量查询员工信息】]获取详细信息类型与 user_id_type 一致'),
      ...
      compensation_type: z
        ...
        .optional(),
      service_company: z.string().describe('任职公司，可通过[【批量查询公司】]获取详细信息').optional(),
      weekly_working_hours: z.string().describe('周工作时长【0~168】').optional(),
      work_calendar_id: z.string().describe('工作日历 ID，可通过[【查询工作日历】]获取详细信息').optional(),
...
export const corehrV2EmployeesAdditionalJobPatch = {
  ...
  schema: {
    data: z
      .object({
        employee_type_id: z.string().describe('人员类型 ID，可通过[【批量查询人员类型】]获取').optional(),
        working_hours_type_id: z.string().describe('工时制度 ID，可通过[【批量查询工时制度】]获取详细信息').optional(),
        work_location_id: z
          .string()
          .describe(
        ...
        service_company: z.string().describe('任职公司，可通过[【批量查询公司】]获取详细信息').optional(),
        weekly_working_hours: z.string().describe('周工作时长【0~168】').optional(),
        work_calendar_id: z.string().describe('工作日历 ID，可通过[【查询工作日历】]获取').optional(),
        position_id: z.string().describe('岗位 ID').optional(),
        employee_subtype_id: z.string().describe('人员子类型 ID').optional(),
      })
      .optional(),
...
export const corehrV2EmployeesInternationalAssignmentCreate = {
  ...
  httpMethod: 'POST',
  description:
    '[Feishu/Lark]-飞书人事（企业版）-员工信息-任职信息-外派信息-创建外派信息-为员工添加外派记录，包括外派信息、任职信息',
  accessTokens: ['tenant'],
  schema: {
    data: z.object({
      work_location_id: z
      ...
      service_company: z.string().describe('外派任职公司 ID- 可通过[【批量查询公司】]获取').optional(),
      work_shift: z
        .string()
        .describe(
          '排班类型- 可通过[【获取字段详情】]接口查询，查询参数如下： - object_api_name：job_data - custom_api_name：work_shift',
      ...
      working_hours_type_id: z.string().describe('工时制度ID- 可通过[【批量查询工时制度】]获取').optional(),
      employee_type_id: z.string().describe('人员类型ID- 可通过[【批量查询人员类型】]获取').optional(),
      department_id: z
        .string()
        .describe('部门 ID- 可通过[【批量查询部门】]获取- 类型与 department_id_type 一致')
        .optional(),
      job_id: z.string().describe('职务 ID- 可通过[【批量查询职务】]获取').optional(),
      job_family_id: z.string().describe('序列 ID- 可通过[【批量查询序列】]获取').optional(),
      job_level_id: z.string().describe('职级 ID- 可通过[【批量查询职级】]获取').optional(),
      job_grade_id: z.string().describe('职等 ID- 可通过[【查询职等】]获取').optional(),
      compensation_type: z
        .string()
        .describe(
          '薪资类型- 可通过[【获取字段详情】]接口查询，查询参数如下： - object_api_name：job_data - custom_api_name：compensation_type',
      ...
      dotted_line_manager_id: z
        ...
        .optional(),
      work_calendar_id: z.string().describe('工作日历 ID- 可通过[【查询工作日历】]获取').optional(),
      position_id: z.string().describe('岗位 ID- 功能灰度中，请联系[技术支持]').optional(),
      employment_id: z
        .string()
...
export const corehrV2EmployeesInternationalAssignmentDelete = {
  ...
  accessTokens: ['tenant'],
  schema: {
    path: z.object({ international_assignment_id: z.string().describe('外派ID- 可通过[批量查询外派]获取') }),
  },
};
export const corehrV2EmployeesInternationalAssignmentList = {
  ...
  httpMethod: 'GET',
  description:
    '[Feishu/Lark]-飞书人事（企业版）-员工信息-任职信息-外派信息-批量查询外派信息-查询员工的外派信息：外派类型、外派地点、职务、职级、上级等',
  accessTokens: ['tenant'],
  schema: {
    params: z
      .object({
        ...
        job_id_list: z
          ...
          .optional(),
        job_family_id_list: z.array(z.string()).describe('外派序列- 可通过[【批量查询序列】]获取').optional(),
        job_level_id_list: z
          .array(z.string())
          .describe(
...
export const corehrV2EnumSearch = {
  ...
  schema: {
    data: z
      .object({ enum_apiname_lists: z.array(z.string()).describe('枚举apiname列表（不传值查询结果为空）').optional() })
      .optional(),
  },
};
    ...
    data: z.object({
      ...
      transfer_info: z
        .object({
          ...
          target_department: z.string().describe('新部门ID，可通过[【批量查询部门】]接口获取').optional(),
          target_work_location: z.string().describe('新工作地点，可通过[【批量查询地点】]接口获取').optional(),
          target_direct_manager: z.string().describe('新直属上级，可通过[【搜索员工信息】]接口获取').optional(),
          target_dotted_manager: z.string().describe('新虚线上级，可通过[【搜索员工信息】]接口获取').optional(),
          target_job: z.string().describe('新职务，可通过[【批量查询职务】]接口获取').optional(),
          target_job_family: z.string().describe('新序列ID，可通过[【批量查询序列】]接口获取').optional(),
          target_job_level: z.string().describe('新职级ID，可通过[【批量查询职级】]接口获取').optional(),
          target_workforce_type: z.string().describe('新人员类型，可通过[【批量查询人员类型】]接口获取').optional(),
          target_employee_subtype: z.string().describe('新人员子类型').optional(),
          target_company: z.string().describe('新公司，详细信息可通过[【批量查询公司】]接口查询获得').optional(),
          target_contract_number: z
            .string()
            .describe('新合同编号，可通过[【批量查询合同】]接口获取详细信息')
            .optional(),
          target_contract_type: z.string().describe('新合同类型，可通过[【批量查询合同】]接口获取详细信息').optional(),
          target_duration_type: z.string().describe('新期限类型，可通过[【批量查询合同】]接口获取详细信息').optional(),
          target_signing_type: z.string().describe('新签订类型，可通过[【批量查询合同】]接口获取详细信息').optional(),
          ...
          target_working_hours_type: z.string().describe('新工时制度，可通过[【批量查询工时制度】]接口获取').optional(),
          ...
          target_employment_change: z
            .object({
              ...
              employee_number: z.string().describe('员工编号，可通过[【搜索员工信息】]接口获取').optional(),
              custom_fields: z
                .array(
                  z.object({
                    custom_api_name: z
            ...
            .describe('新工作信息')
            .optional(),
          target_job_grade: z.string().describe('新职等，可通过[【查询职等】]接口获取').optional(),
...
export const corehrV2JobChangeRevoke = {
  ...
  schema: {
    ...
    params: z
      ...
      .optional(),
    path: z.object({ job_change_id: z.string().describe('异动id，[【搜索异动信息】] 获取ID') }),
  },
};
export const corehrV2JobChangeSearch = {
  ...
  schema: {
    data: z
      .object({
        employment_ids: z.array(z.string()).describe('雇员 ID 列表，可通过[【搜索员工信息】]接口获取').optional(),
        job_change_ids: z
          .array(z.string())
        ...
        exception_statuses: z
          .array(
            z.enum(['pending', 'processed']).describe('Options:pending(pending 未处理),processed(processed 已处理)'),
          )
...
export const corehrV2JobFamilyBatchGet = {
  ...
  httpMethod: 'POST',
  description:
    '[Feishu/Lark]-飞书人事（企业版）-岗职务管理-序列-根据条件批量获取序列信息-通过序列 ID 或序列 Code 批量查询当前生效版本序列的详情信息，包括序列名称、启用状态、上级序列等',
  accessTokens: ['tenant'],
  schema: {
    data: z
      .object({
        job_family_ids: z
          .array(z.string())
          .describe(
            '序列ID列表。- 序列 ID 列表和序列 Code 列表至少有一项有值，否则接口将调用失败。- 未设置时表示不筛选该条件- ID获取方式：调用[【创建序列】][【批量查询序列】]等接口可以返回序列ID',
          )
          .optional(),
        job_family_codes: z
          .array(z.string())
          .describe(
            '序列 Code 列表。- 序列 ID 列表和序列 Code 列表至少有一项有值，否则接口将调用失败。- 未设置时表示不筛选该条件- Code获取方式：调用[【创建序列】][【批量查询序列】]等接口可以返回序列Code',
          )
          .optional(),
      })
      .optional(),
...
export const corehrV2JobGradeCreate = {
  ...
  schema: {
    ...
    params: z
      .object({ client_token: z.string().describe('根据client_token是否一致来判断是否为同一请求').optional() })
      .optional(),
  },
};
...
export const corehrV2JobLevelBatchGet = {
  ...
  httpMethod: 'POST',
  description:
    '[Feishu/Lark]-飞书人事（企业版）-岗职务管理-职级-根据条件批量获取职级信息-该接口支持通过职级ID或职级Code批量查询职级详情信息，包括名称、描述、启用状态等',
  accessTokens: ['tenant'],
  schema: {
    data: z
      .object({
        job_level_ids: z
          .array(z.string())
          .describe(
            '职级 ID 列表- 职级 ID 列表和职级 Code 列表至少有一项有值，否则接口将调用失败。- 未设置时表示不筛选该条件- ID获取方式：调用[【创建职级】][【批量查询职级】]等接口可以返回职级ID',
          )
          .optional(),
        job_level_codes: z
          .array(z.string())
          .describe(
            '职级 Code 列表- 职级 ID 列表和职级 Code 列表至少有一项有值，否则接口将调用失败。- 未设置时表示不筛选该条件- Code获取方式：调用[【创建职级】][【批量查询职级】]等接口可以返回职级Code',
          )
          .optional(),
      })
      .optional(),
...
export const corehrV2LocationAddressCreate = {
  ...
  schema: {
    data: z.object({
      country_region_id: z.string().describe('国家 / 地区 ID- 可通过[【查询国家/地区信息】]接口获取'),
      region_id: z.string().describe('主要行政区 ID- 可通过[【查询省份/行政区信息】]接口获取'),
      city_id: z.string().describe('城市ID。- 详情调用[【查询城市信息】]获取'),
      distinct_id: z.string().describe('区/县ID- 详情可通过[【查询区县信息】]接口获取'),
    ...
    params: z
      .object({ client_token: z.string().describe('根据 client_token 是否一致来判断是否为同一请求').optional() })
      .optional(),
    path: z.object({
      location_id: z
        .string()
...
export const corehrV2LocationAddressPatch = {
  ...
  schema: {
    data: z
      .object({
        country_region_id: z.string().describe('国家 / 地区 ID- 可通过[【查询国家/地区信息】]接口获取').optional(),
        region_id: z.string().describe('主要行政区 ID- 可通过[【查询省份/行政区信息】]接口获取').optional(),
        city_id: z.string().describe('城市ID。- 详情调用[【查询城市信息】]获取').optional(),
        distinct_id: z.string().describe('区/县ID- 详情可通过[【查询区县信息】]接口获取').optional(),
        local_address_line1: z
          .string()
          .describe('地址行 1（非拉丁语系的本地文字）- 填写规则可见[【地址填写指南】]')
          .optional(),
    ...
    data: z
      .object({
        name_list: z
          .array(
            z.object({
              local_primary: z.string().describe('姓 - 本地文字').optional(),
              local_first_name: z.string().describe('名 - 本地文字').optional(),
              country_region_id: z.string().describe('国家/地区，可通过[【查询国家/地区信息】]获取'),
              name_type: z
                .object({ enum_name: z.string().describe('枚举值') })
                .describe(
        ...
        address_list: z
          .array(
            z.object({
              ...
              country_region_id: z.string().describe('国家/地区，可通过[【查询国家/地区信息】]获取'),
              region_id: z.string().describe('主要行政区，可通过[【查询省份/主要行政区信息】]获取').optional(),
          ...
          .array(
            z.object({
              ...
              field_of_study_name: z
                ...
                .optional(),
              country_region_id: z.string().describe('国家/地区ID，可通过[【查询国家/地区信息】]获取').optional(),
        ...
        bank_account_list: z
          .array(
            z.object({
              ...
              bank_id_v2: z.string().describe('银行 ID，可通过[【查询银行信息】]接口查询获得').optional(),
              branch_id_v2: z
                .string()
              ...
              bank_account_type: z
                ...
                .optional(),
              currency_id: z.string().describe('货币 ID- 详细信息可通过[【查询货币信息】]接口查询获得').optional(),
              custom_fields: z
                .array(
                  z.object({
                    custom_api_name: z.string().describe('自定义字段 apiname，即自定义字段的唯一标识'),
        ...
        national_id_list: z
          .array(
            z.object({
              national_id_type_id: z.string().describe('国家证件类型，可通过[【批量查询国家证件类型】]获得'),
              national_id_number: z.string().describe('证件号码'),
              issue_date: z.string().describe('证件签发日期').optional(),
              expiration_date: z.string().describe('证件到期日期').optional(),
              country_region_id: z.string().describe('国家/地区ID，可通过[【查询国家/地区信息】]获取'),
              issued_by: z.string().describe('证件签发机构').optional(),
              custom_fields: z
                .array(
                  z.object({
          ...
          .array(
            z.object({
              ...
              gender: z
                ...
                .optional(),
              date_of_birth: z.string().describe('生日').optional(),
              nationality_id_v2: z.string().describe('国籍 ID，可通过[【查询国籍信息】]接口查询').optional(),
              national_id_list: z
                .array(
                  z.object({
                    national_id_type_id: z.string().describe('国家证件类型，可通过[【批量查询国家证件类型】]获得'),
              ...
              birth_certificate_of_child: z
                .array(z.object({ id: z.string().describe('上传文件ID，可通过[【上传文件】]获取').optional() }))
                .describe('出生证明')
                .optional(),
            }),
          )
        ...
        political_affiliations: z
          ...
          .optional(),
        talent_id: z.string().describe('人才ID，可通过[【获取人才列表】]获取').optional(),
        custom_fields: z
          .array(
            z.object({
              custom_api_name: z.string().describe('自定义字段 apiname，即自定义字段的唯一标识'),
          ...
          .array(
            z.object({
              ...
              resident_status: z
                ...
                .optional(),
              tax_country_region_id: z.string().describe('国家/地区，可通过[【查询国家/地区信息】]接口查询').optional(),
              custom_fields: z
                .array(
                  z.object({
                    field_name: z.string().describe('字段名'),
    ...
    data: z
      .object({
          ...
          .array(
            z.object({
              ...
              field_of_study_name: z
                ...
                .optional(),
              country_region_id: z.string().describe('国家地区ID，可通过[【查询国家/地区信息】]获取').optional(),
              expected_end_date: z.string().describe('预期结束日期').optional(),
              custom_fields: z
                .array(
                  z.object({
        ...
        bank_account_list: z
          .array(
            z.object({
              ...
              account_holder: z.string().describe('开户人姓名'),
              branch_name: z.string().describe('支行名称- 如果有对应支行 ID，请使用 branch_id_v2').optional(),
              bank_id_v2: z.string().describe('银行 ID，详细信息可通过[【查询银行信息】]接口查询获得').optional(),
              branch_id_v2: z
                .string()
          ...
          .array(
            z.object({
              ...
              gender: z
                ...
                .optional(),
              date_of_birth: z.string().describe('生日').optional(),
              nationality_id_v2: z.string().describe('国籍 ID，可通过[【查询国籍信息】]获取').optional(),
              national_id_list: z
                .array(
                  z.object({
                    national_id_type_id: z.string().describe('国家证件类型，可通过[【批量查询国家证件类型】]获得'),
              ...
              address: z
                ...
                .optional(),
              birth_certificate_of_child: z
                .array(z.object({ id: z.string().describe('文件ID，可通过[【上传文件】]获取').optional() }))
                .describe('出生证明')
                .optional(),
            }),
          )
        ...
        personal_profile: z
          ...
          .optional(),
        native_region: z.string().describe('籍贯 ID，可通过[【查询省份/主要行政区信息】]获取').optional(),
        hukou_type: z
          .object({ enum_name: z.string().describe('枚举值') })
          .describe(
          ...
          .array(
            z.object({
              ...
              resident_status: z
                ...
                .optional(),
              tax_country_region_id: z.string().describe('国家/地区，可通过[【查询国家/地区信息】]获取').optional(),
              custom_fields: z
                .array(
                  z.object({
                    field_name: z.string().describe('字段名'),
...
export const corehrV2PreHireComplete = {
  ...
  accessTokens: ['tenant'],
  schema: {
    path: z.object({ pre_hire_id: z.string().describe('待入职ID,可从[待入职列表]接口获取') }),
  },
};
        ...
        .object({
          name: z
            .object({
              ...
              local_middle_name: z.string().describe('本地中间名').optional(),
              local_primary: z.string().describe('姓 - 本地文字').optional(),
              country_region_id: z.string().describe('国家 / 地区，可以通过接口[查询国家/地区信息]获得').optional(),
          ...
          gender_id: z
            ...
            .optional(),
          nationality_v2_id: z.string().describe('国籍（新），可以通过[查询国籍信息]接口获得').optional(),
          ...
          resident_tax_list: z
            .array(
              z.object({
                ...
                tax_address: z
                  .object({
                    country_region_id: z.string().describe('国家 / 地区，可以通过接口[查询国家/地区信息]获得'),
                    region_id: z.string().describe('主要行政区，可以通过接口[查询省份/行政区信息]获得').optional(),
                    local_address_line1: z.string().describe('地址行 1（非拉丁语系的本地文字）').optional(),
                    local_address_line2: z.string().describe('地址行 2（非拉丁语系的本地文字）').optional(),
                    local_address_line3: z.string().describe('地址行 3（非拉丁语系的本地文字）').optional(),
                    local_address_line4: z.string().describe('地址行 4（非拉丁语系的本地文字）').optional(),
                    ...
                    city_id_v2: z.string().describe('城市，可以通过接口[查询城市信息]获取详情').optional(),
                    district_id_v2: z.string().describe('区/县，可以通过接口[查询区/县信息]获取详情').optional(),
                  })
                  .describe('纳税地址')
                  .optional(),
            ...
            .describe('纳税身份信息')
            .optional(),
          born_country_region: z.string().describe('出生国家/地区，可以通过[查询国家/地区信息]接口获取').optional(),
          is_disabled: z.boolean().describe('是否残疾').optional(),
          disable_card_number: z.string().describe('残疾证号').optional(),
          is_old_alone: z.boolean().describe('是否孤老').optional(),
          is_martyr_family: z.boolean().describe('是否烈属').optional(),
            ...
            .array(
              z.object({
                ...
                national_ids: z
                  .array(
                    z.object({
                      country_region_id: z.string().describe('国家/地区，可以通过[查询国家/地区信息]接口获取'),
                      national_id_type_id: z.string().describe('国家证件类型，可以通过[批量查询国家证件类型]接口获取'),
                      national_id_number: z.string().describe('证件号码'),
                ...
                address: z
                  .object({
                    country_region_id: z.string().describe('国家/地区，可以通过[查询国家/地区信息]接口获取'),
                    region_id: z.string().describe('主要行政区，可以通过接口[查询省份/行政区信息]获取').optional(),
                    local_address_line1: z.string().describe('地址行 1（非拉丁语系的本地文字）').optional(),
                    local_address_line2: z.string().describe('地址行 2（非拉丁语系的本地文字）').optional(),
                    local_address_line3: z.string().describe('地址行 3（非拉丁语系的本地文字）').optional(),
                    local_address_line4: z.string().describe('地址行 4（非拉丁语系的本地文字）').optional(),
          ...
          bank_account_list: z
            .array(
              z.object({
                ...
                bank_account_number: z.string().describe('银行账号'),
                account_holder: z.string().describe('开户人姓名'),
                country_region_id: z.string().describe('国家/地区，可以通过[查询国家/地区信息]接口获取').optional(),
                bank_account_usages: z
                  .array(z.string())
                  .describe(
            ...
            .array(
              z.object({
                personal_profile_type: z
                  ...
                  .optional(),
                files: z
                  .array(z.object({ id: z.string().describe('上传文件ID，可以通过[上传文件]接口获取').optional() }))
                  .describe('资料文件列表')
                  .optional(),
              }),
            )
            ...
            .array(
              z.object({
                ...
                address: z
                  .object({
                    country_region_id: z.string().describe('国家 / 地区，可以通过[查询国家/地区信息]接口获取'),
                    region_id: z.string().describe('主要行政区，可以通过[查询省份/行政区信息]接口获取').optional(),
                    local_address_line1: z.string().describe('地址行 1（非拉丁语系的本地文字）').optional(),
                    local_address_line2: z.string().describe('地址行 2（非拉丁语系的本地文字）').optional(),
                    local_address_line3: z.string().describe('地址行 3（非拉丁语系的本地文字）').optional(),
                    local_address_line4: z.string().describe('地址行 4（非拉丁语系的本地文字）').optional(),
          ...
          ethnicity_race: z
            ...
            .optional(),
          native_region: z.string().describe('籍贯，可以通过[查询省份/行政区信息]接口获取').optional(),
          hukou_type: z
            .string()
            .describe(
      ...
      offer_info: z
        .object({
          offer_id: z
            ...
            .optional(),
          offer_hr_id: z.string().describe('Offer HR 雇佣 ID，可以通过[批量查询员工信息]接口获取').optional(),
          department_id: z.string().describe('部门 ID，可以通过[批量查询部门]接口获取').optional(),
          direct_leader_id: z.string().describe('直属领导的雇佣 ID，可以通过[批量查询员工信息]接口获取').optional(),
          dotted_line_manager_id: z
            .string()
            .describe('虚线上级ID，可以通过[批量查询员工信息]接口获取- 功能灰度中，如有需求请联系[技术支持]')
            .optional(),
          job_id: z.string().describe('职务 ID，可以通过[批量查询职务]接口获取').optional(),
          job_family_id: z.string().describe('序列 ID，可以通过[批量查询序列]接口获取').optional(),
          job_level_id: z.string().describe('职级 ID，可以通过[批量查询职级]接口获取').optional(),
          ...
          onboarding_location_id: z.string().describe('入职地点 ID，可以通过[批量查询地点]接口获取').optional(),
          office_location_id: z.string().describe('办公地点 ID，可以通过[批量查询地点]接口获取').optional(),
          ...
          employee_type_id: z.string().describe('人员类型 ID，可以通过接口[批量查询人员类型]获取').optional(),
          ...
          entry_mode: z
            ...
            .optional(),
          social_security_city_id: z.string().describe('社保城市 ID，可以通过[批量查询地点]接口获取').optional(),
          contract_type: z
            .string()
            .describe(
            ...
            .optional(),
          company: z.string().describe('公司 ID，可以通过[批量查询公司]接口获取').optional(),
          cost_center_rate: z
            .array(
              z.object({
                cost_center_id: z.string().describe('成本中心 ID，可以通过[搜索成本中心信息]接口获取').optional(),
            ...
            .optional(),
          job_grade_id: z.string().describe('职等ID，可以通过[查询职等]接口获取').optional(),
          custom_fields: z
            .array(
              z.object({
                field_name: z.string().describe('字段名'),
            ...
            .optional(),
          service_company: z.string().describe('任职公司，可以通过[批量查询公司]接口获取').optional(),
          work_shift: z
            .string()
            .describe(
          ...
          compensation_type: z
            ...
            .optional(),
          work_location_id: z.string().describe('工作地点ID，可以通过[批量查询地点]接口获取').optional(),
          onboarding_address_id: z.string().describe('入职地址ID，可以通过[批量查询地点]接口获取').optional(),
          office_address_id: z.string().describe('办公地址ID，，可以通过[批量查询地点]接口获取').optional(),
          position_id: z.string().describe('岗位ID').optional(),
          working_calendar_id: z.string().describe('工作日历ID').optional(),
          working_hours_type: z.string().describe('工时制度，可以通过[批量查询工时制度]接口获得').optional(),
          ...
          default_cost_center: z
            .object({
              cost_center_id: z.string().describe('成本中心 ID，可以通过[搜索成本中心信息]接口获取'),
...
export const corehrV2PreHireDelete = {
  ...
  accessTokens: ['tenant'],
  schema: {
    path: z.object({ pre_hire_id: z.string().describe('待入职ID，可通过[搜索接口]获取') }),
  },
};
export const corehrV2PreHirePatch = {
  ...
  schema: {
    data: z
        ...
        basic_info_update: z
          .object({
            names: z
              .array(
                z.object({
                  ...
                  custom_local_name: z.string().describe('自定义姓名（本地文字）').optional(),
                  custom_western_name: z.string().describe('自定义姓名（西方文字）').optional(),
                  country_region: z.string().describe('国家/地区，可以通过接口[查询国家/地区信息]获得'),
                  name_type: z
                    .string()
                    .describe(
            ...
            emails: z
              ...
              .optional(),
            nationality_v2_id: z.string().describe('国籍，可以通过[查询国籍信息]接口获取').optional(),
            additional_nationality_id_list: z
              .array(z.string())
            ...
            resident_tax_list: z
              ...
              .optional(),
            born_country_region: z.string().describe('出生国家/地区，可以通过接口[查询国家/地区信息]获得').optional(),
            is_disabled: z.boolean().describe('是否残疾').optional(),
            disable_card_number: z.string().describe('残疾证号').optional(),
            is_old_alone: z.boolean().describe('是否孤老').optional(),
            is_martyr_family: z.boolean().describe('是否烈属').optional(),
              ...
              .array(
                z.object({
                  ...
                  national_ids: z
                    .array(
                      z.object({
                        country_region_id: z.string().describe('国家 / 地区，可以通过[查询国家/地区信息]接口获得'),
            ...
            national_id_list: z
              .array(
                z.object({
                  country_region_id: z.string().describe('国家 / 地区，可以通过接口[查询国家/地区信息]获得'),
                  national_id_type_id: z.string().describe('国家证件类型，可以通过[批量查询国家证件类型]接口获得'),
                  national_id_number: z.string().describe('证件号码'),
                  issue_date: z.string().describe('证件签发日期').optional(),
                  expiration_date: z.string().describe('证件到期日期').optional(),
                  issued_by: z.string().describe('证件签发机构').optional(),
        ...
        offer_info_update: z
          .object({
            ...
            ats_application_id: z
              ...
              .describe('招聘应用 ID，仅支持飞书招聘 ID，可以通过[获取投递列表]接口获取')
              .optional(),
            onboarding_location_id: z.string().describe('入职地点ID，可以通过[批量查询地点]接口获得').optional(),
            onboarding_address_id: z.string().describe('入职地址ID，可以通过[批量查询地点]接口获得').optional(),
            office_location_id: z.string().describe('办公地点ID，可以通过[批量查询地点]接口获得').optional(),
            office_address_id: z.string().describe('办公地址ID，可以通过[批量查询地点]接口获得').optional(),
            employment_type: z
              .string()
              .describe(
            ...
            cost_center_rates: z
              .array(
                z.object({
                  cost_center_id: z.string().describe('成本中心 ID，可以通过[搜索成本中心信息]接口获得').optional(),
                  rate: z.number().describe('分摊比例，大于0小于等于100的正整数').optional(),
                  new_rate: z.number().describe('分摊比例').optional(),
                }),
              )
            ...
            check_in_method: z
              ...
              .optional(),
            company: z.string().describe('公司主体，可以通过[批量查询公司]接口查询').optional(),
            work_shift: z
              .string()
              .describe(
                '排班，枚举值可查询[获取字段详情]接口获取，按如下参数查询即可： - object_api_name = pre_hire- custom_api_name = work_shift',
            ...
            offer_hr_id: z.string().describe('Offer HR 雇佣ID，可以通过[批量查询员工信息]接口获取').optional(),
            job_id: z.string().describe('职务 ID，可以通过[批量查询职务]接口获取').optional(),
            job_family_id: z.string().describe('序列 ID，可以通过[批量查询序列]接口获取').optional(),
            job_level_id: z.string().describe('职级 ID，可以通过[批量查询职级]接口获取').optional(),
            job_grade_id: z.string().describe('职等ID，可以通过[查询职等]接口获取').optional(),
            ...
            direct_leader_id: z.string().describe('直属上级，可以通过[批量查询员工信息]接口获取').optional(),
            dotted_line_manager_id: z
              .string()
              .describe('虚线上级，可以通过[搜索员工信息]接口获取详情- 功能灰度中，如有需求请联系[技术支持]')
              .optional(),
            department_id: z.string().describe('部门 ID，可以通过[批量查询部门]接口获取').optional(),
            social_security_city: z.string().describe('社保城市ID，可以通过[批量查询地点]接口获得').optional(),
            work_location_id: z.string().describe('工作地点ID，可以通过[批量查询地点]接口获得').optional(),
            working_calendar: z.string().describe('工作日历，可以通过[查询日历信息]接口获得').optional(),
            working_hours_type: z.string().describe('工时制度，可以通过[批量查询工时制度]接口获得').optional(),
            seniority_date: z.string().describe('司龄起算日期').optional(),
            seniority_adjust_information_list: z
              .array(
            ...
            work_station: z.string().describe('工位').optional(),
            service_company: z.string().describe('任职公司，可以通过[批量查询公司]接口查询').optional(),
            non_compete_covenant: z.boolean().describe('是否包含竞业条款').optional(),
            pathway: z.string().describe('通道').optional(),
            default_cost_center: z
              .object({
                cost_center_id: z.string().describe('成本中心 ID，可以通过[搜索成本中心信息]接口获得'),
                is_herit: z.boolean().describe('是否继承岗位/部门的默认成本中心'),
              })
              .describe('默认成本中心- 功能灰度中，如有需求请联系[技术支持]')
              .optional(),
      ...
      .optional(),
    path: z.object({ pre_hire_id: z.string().describe('待入职ID，可以通过[搜索待入职人员信息]接口获得') }),
  },
};
...
export const corehrV2PreHireRestoreFlowInstance = {
  ...
  schema: {
    data: z.object({
      pre_hire_id: z.string().describe('待入职ID,可从[待入职列表]接口获取'),
  ...
  schema: {
    data: z
      .object({
        ...
        person_ids: z.array(z.string()).describe('个人信息 ID 列表，可以通过[【事件】更新个人信息]获取').optional(),
        ...
        job_family_ids: z.array(z.string()).describe('序列 ID 列表，可以通过[批量查询序列]接口获取').optional(),
        key_word: z
          .string()
...
export const corehrV2PreHireWithdrawOnboarding = {
  ...
  schema: {
    data: z.object({
      pre_hire_id: z.string().describe('待入职ID，可以通过[搜索待入职人员信息]接口获得'),
...
export const corehrV2ProbationSearch = {
  ...
  schema: {
    data: z
      .object({
        employment_ids: z.array(z.string()).describe('雇佣 ID 列表，可通过[【搜索员工信息】]接口获取').optional(),
        department_ids: z.array(z.string()).describe('部门 ID 列表，可通过[【批量查询部门】]接口获取').optional(),
...
export const corehrV2ProbationSubmit = {
  ...
  schema: {
    data: z.object({
      employment_id: z.string().describe('试用期人员的雇佣 ID，可通过[【搜索员工信息】]接口获取'),
...
export const corehrV2ProbationWithdraw = {
  ...
  accessTokens: ['tenant'],
  schema: {
    data: z.object({ employment_id: z.string().describe('试用期人员的雇佣 ID，可通过[【搜索员工信息】]接口获取') }),
    params: z
      .object({
        client_token: z.string().describe('根据 client_token 是否一致来判断是否为同一请求').optional(),
        user_id_type: z.enum(['open_id', 'union_id', 'user_id', 'people_corehr_id']).describe('用户ID类型').optional(),
...
export const corehrV2ProcessRevokeUpdate = {
  ...
  schema: {
    ...
    params: z
      ...
      .optional(),
    path: z.object({ process_id: z.string().describe('流程实例 ID。可通过[查询流程实例列表]接口获取') }),
  },
};
export const corehrV2ProcessWithdrawUpdate = {
  ...
  schema: {
    ...
    params: z
      ...
      .optional(),
    path: z.object({ process_id: z.string().describe('流程实例ID。可通过[查询流程实例列表]接口获取') }),
  },
};
  ...
  schema: {
    data: z.object({
      ...
      system_approval: z
        ...
        .optional(),
      reason: z.string().describe('通过原因**默认值**：""').optional(),
      field_values_v2: z
        .array(
          z.object({
            variable_api_name: z.string().describe('变量唯一标识，可通过[获取流程表单数据]查询变量').optional(),
            variable_value: z
              .object({
                ...
                file_value: z
                  .object({
                    open_file_id: z.string().describe('通过在[上传文件接口]上传文件后获得的ID').optional(),
...
export const corehrV2ProcessGet = {
  ...
  httpMethod: 'GET',
  description:
    '[Feishu/Lark]-飞书人事（企业版）-流程-流程实例-获取单个流程详情-根据流程实例 id（process_id）获取单个流程详情（此功能不受数据权限范围控制）。比如流程状态、流程发起人、流程发起时间、流程摘要、流程里的所有待办、已办、抄送任务等',
  accessTokens: ['tenant'],
  schema: {
    params: z
      .object({
...
export const corehrV2ProcessList = {
  ...
  httpMethod: 'GET',
  description:
    '[Feishu/Lark]-飞书人事（企业版）-流程-流程实例-查询流程实例列表-本接口用于查询流程实例列表，支持通过流程定义 ID 等进行查询（此功能不受数据权限范围控制），其中：- 流程实例：是指用户在业务功能或者飞书人事的审批中心发起的具体流程，process_id 是其唯一标识。- 流程定义：是指管理员在设置侧配置的流程，类似流程模板，flow_definition_id 是其唯一标识。用户发起的流程是按照对应的流程定义的配置生成',
  accessTokens: ['tenant'],
  schema: {
    params: z.object({
      statuses: z
      ...
      page_token: z
        ...
        .optional(),
      page_size: z.number().describe('分页大小，取值范围：1 ～ 100'),
      modify_time_from: z
        .string()
        .describe(
    ...
    data: z
      .object({
        ...
        department_ids: z
          ...
          .optional(),
        employee_type_ids: z.array(z.string()).describe('人员类型 ID 列表- 可通过[查询人员类型]获取详情').optional(),
        work_location_ids: z
          .array(z.string())
