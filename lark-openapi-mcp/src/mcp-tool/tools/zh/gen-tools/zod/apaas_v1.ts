...
export const apaasV1AppList = {
  ...
  schema: {
    params: z
      .object({
        page_size: z.string().describe('分页大小，必填，范围：【0，50】').optional(),
        page_token: z
          .string()
          .describe(
...
export const apaasV1ApplicationAuditLogGet = {
  ...
  accessTokens: ['user'],
  schema: {
    params: z.object({ log_id: z.string().describe('审计日志ID信息（通过[查询审计日志列表]获取单条日志ID）') }),
    path: z.object({ namespace: z.string().describe('应用命名空间') }),
    useUAT: z.boolean().describe('使用用户身份请求, 否则使用应用身份').optional(),
  },
};
export const apaasV1ApplicationEnvironmentVariableGet = {
  ...
  httpMethod: 'GET',
  description:
    '[Feishu/Lark]-飞书 aPaaS-环境变量-查询环境变量详情-查询基于飞书 aPaaS 开发的应用的环境变量详情，包括名称、描述、变量值等',
  accessTokens: ['tenant'],
  schema: {
    path: z.object({
...
export const apaasV1ApplicationFunctionInvoke = {
  ...
  accessTokens: ['tenant'],
  schema: {
    data: z.object({ params: z.string().describe('函数输入参数（JSON 序列化后的字符串）').optional() }).optional(),
    path: z.object({
      namespace: z.string().describe('应用命名空间'),
...
export const apaasV1ApplicationRecordPermissionMemberBatchCreateAuthorization = {
  ...
  schema: {
    data: z
      .object({ user_ids: z.array(z.string()).describe('需要新增的用户 ID 列表，使用飞书 aPaaS 的用户 ID').optional() })
      .optional(),
    path: z.object({
      namespace: z.string().describe('应用命名空间'),
...
export const apaasV1ApplicationRecordPermissionMemberBatchRemoveAuthorization = {
  ...
  schema: {
    data: z
      .object({ user_ids: z.array(z.string()).describe('需要删除的用户 ID 列表，使用飞书 aPaaS 的用户 ID').optional() })
      .optional(),
    path: z.object({
      namespace: z.string().describe('应用命名空间'),
      record_permission_api_name: z.string().describe('记录权限 API 名称'),
...
export const apaasV1ApplicationRoleMemberBatchCreateAuthorization = {
  ...
  schema: {
    data: z
      .object({
        user_ids: z.array(z.string()).describe('需要新增的用户 ID 列表，使用飞书 aPaaS 的用户 ID').optional(),
        department_ids: z.array(z.string()).describe('需要新增的部门 ID 列表，使用飞书 aPaaS 的部门 ID').optional(),
      })
      .optional(),
    path: z.object({
      namespace: z.string().describe('应用命名空间'),
...
export const apaasV1ApplicationRoleMemberBatchRemoveAuthorization = {
  ...
  schema: {
    data: z
      .object({
        user_ids: z.array(z.string()).describe('需要删除的用户 ID 列表，使用飞书 aPaaS 的用户 ID').optional(),
        department_ids: z.array(z.string()).describe('需要删除的部门 ID 列表，使用飞书 aPaaS 的部门 ID').optional(),
      })
      .optional(),
    path: z.object({
      namespace: z.string().describe('应用命名空间'),
...
export const apaasV1SeatActivityList = {
  ...
  httpMethod: 'GET',
  description:
    '[Feishu/Lark]-飞书 aPaaS-席位活跃-查询席位活跃详情-获取租户下用户使用飞书 aPaaS 席位最近访问应用时间。需要飞书 aPaaS 系统管理员作为授权人调用当前API',
  accessTokens: ['user'],
  schema: {
    params: z.object({
      seat_type: z
...
export const apaasV1SeatAssignmentList = {
  ...
  httpMethod: 'GET',
  description:
    '[Feishu/Lark]-飞书 aPaaS-席位分配-查询席位分配详情-获取租户下平台席位和应用访问席位分配详情，如用户 ID 、应用命名空间等，需要飞书 aPaaS 系统管理员作为授权人调用当前 API',
  accessTokens: ['user'],
  schema: {
    params: z.object({
      seat_type: z
