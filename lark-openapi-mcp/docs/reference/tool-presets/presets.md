...
| drive.v1.file.createFolder | Create folder | | ✓ | | | | ✓ | | |
| drive.v1.permissionMember.create | Add collaborator permissions | | ✓ | | | | ✓ | | |
| drive.v1.permissionMember.transferOwner | Transfer owner | | ✓ | | | | ✓ | | |
...
The default preset that includes commonly used tools across messaging, documents, drive, databases, contacts, task, and calendar. Recommended for most users.
