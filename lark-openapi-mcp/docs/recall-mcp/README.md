...
This is the `ticoag/lark` maintained Feishu/Lark Open Platform Developer Documentation Retrieval MCP, developed alongside [Feishu/Lark OpenAPI MCP](../../README.md). The upstream MCP implementation is forked from `larksuite/lark-openapi-mcp`.
